...
INSERT INTO `projects` (`id`, `name`, `comment`, `when_add`, `updated`) VALUES (NULL, 'test1', 'test comment', UNIX_TIMESTAMP(), UNIX_TIMESTAMP());
INSERT INTO `projects` (`id`, `name`, `comment`, `when_add`, `updated`) VALUES (NULL, 'test2', 'test comment 2', UNIX_TIMESTAMP(), UNIX_TIMESTAMP());
...
INSERT INTO `domains` (`id`, `server_id`, `name`, `checked`, `comment`, `updated`, `when_add`) VALUES
  (NULL, 1, 'google.com', 0, 'comment domain 1', 0, 123);
INSERT INTO `domains` (`id`, `server_id`, `name`, `checked`, `comment`, `updated`, `when_add`) VALUES
  (NULL, 1, 'yandex.ru', 0, 'comment domain 2', 0, 123);
INSERT INTO `domains` (`id`, `server_id`, `name`, `checked`, `comment`, `updated`, `when_add`) VALUES
  (NULL, 1, 'www.yandex.ru', 0, 'comment domain 2', 0, 123);
...
VALUES (NULL, '1', '1.1.1.1', 'server 1', '1', NULL, 'server comment 1', '0', UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),
       ...
       (NULL, '1', '2.2.2.3', 'server 3', '1', NULL, 'server comment 3', '1', UNIX_TIMESTAMP(), UNIX_TIMESTAMP());
...
(0, 1, 'MySQL1', '1.1', 0, 0, 'http://mysql.com', 'banner', 'tcp', 3306, 0, 0, 'mysql comment', 0, 0),
(0, 1, 'MySQL2', '1.1', 0, 0, 'http://mysql.com', 'banner', 'tcp', 3306, 0, 0, 'mysql comment', 0, 0),
(0, 1, 'MySQL3', '1.1', 0, 0, 'http://mysql.com', 'banner', 'tcp', 3306, 0, 0, 'mysql comment', 0, 0);
...
INSERT INTO `users` (`id`, `group_id`, `login`, `email`, `hash_id`, `shell_id`, `home_dir`, `vip`, `updated`) VALUES
       ...
       (NULL, 5, 'User3', 'email7@example.com', 1, NULL, '', 0, 0),
       (NULL, 5, 'User4', 'email8@example.com', 1, NULL, '', 0, 0);
...
INSERT INTO `tasks` (`id`, `object_id`, `type`, `name`, `description`, `status`, `updated`, `when_add`) VALUES
       ...
       (NULL, 1, 'web-app', 'task 3', 'comment task 3', 0, 0, 0)    ;
...
INSERT INTO `vulns` (`id`, `type`, `vuln_type_id`, `object_id`, `risk_level_id`, `name`, `description`, `exploit_link`, `updated`, `when_add`) VALUES
       ...
       (NULL, 'server-software', 3, 1, 1, 'Vuln3', 'About3', 'Link3', 0, 0);
