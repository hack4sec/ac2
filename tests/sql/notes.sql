...
INSERT INTO `tasks` (`id`, `object_id`, `type`, `name`, `description`, `status`, `updated`, `when_add`) VALUES
  (NULL, 1, 'server', 'task 1', 'comment task 1', 1, 0, 0),
  (NULL, 1, 'server', 'task 2', 'comment task 2', 1, 0, 0),
  (NULL, 1, 'server-software', 'task 1', 'comment task 1', 1, 0, 0),
  (NULL, 1, 'server-software', 'task 2', 'comment task 2', 1, 0, 0),
  (NULL, 1, 'web-app', 'task 1', 'comment task 1', 1, 0, 0),
  (NULL, 1, 'web-app', 'task 2', 'comment task 2', 1, 0, 0)    ;

TRUNCATE TABLE `notes`;
INSERT INTO `notes` (`id`, `project_id`, `content`, `when_add`) VALUES
(0, 1, 'note 1 note 1 note 1', 1468999600),
(0, 1, 'note 2 note 2 note 2', 1468999600),
(0, 1, 'note 3 note 3 note 3', 1468999600),
(0, 1, 'note 4 note 4 note 4', 1468999600),
(0, 1, 'note 5 note 5 note 5', 1468999600),
(0, 1, 'note 6 note 6 note 6', 1468999600);